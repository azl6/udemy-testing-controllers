...
class BeerOrderControllerTest {
    ...
    void listOrders() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/customers/85d4506-e7dd-446e-a092-5f30b98e7b26/orders"))
    ...
    void getOrder() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/customers/85d4506-e7dd-446e-a092-5f30b98e7b26/orders/f25767d9-342a-48ac-a788-0a7a38ae6fb3"))
                .andExpect(status().isOk())
